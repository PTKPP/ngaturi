...
export function MapsSection({ events, config }: { events: InvitationEvent[]; config: MapsModule }) {
  ...
  return <section className={`${styles.section} ${styles.mapsSection}`} id="wedding-default-maps" aria-labelledby="wedding-default-maps-title">
    <Reveal className={styles.sectionIntro}><ThemeIcon name="map" /><p className={styles.kicker}>Lokasi acara</p><h2 id="wedding-default-maps-title">Temukan tempatnya</h2><p>Alamat ditampilkan tanpa memuat layanan peta pihak ketiga.</p></Reveal>
