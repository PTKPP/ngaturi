...
export function GiftSection({ gift }: { gift: GiftModule }) {
  ...
  return <section className={`${styles.section} ${styles.giftSection}`} id="wedding-default-gift" aria-labelledby="wedding-default-gift-title"><Reveal className={styles.giftCard}>
    <ThemeIcon name="gift" /><p className={styles.kicker}>Love Gift</p><h2 id="wedding-default-gift-title">Tanda Kasih</h2><p>Doa dan kehadiran Anda adalah hadiah yang berarti bagi kami.</p>
