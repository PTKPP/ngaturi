...
- Source assets used at runtime: none. Ngaturi uses original local SVG placeholders, a local thumbnail, inline icons, and a generated shared ambient audio track.
