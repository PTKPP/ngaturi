  ...
  apps: [
    {
      ...
      env: definedValues({
        NODE_ENV: "production",
        HOSTNAME: envValue("FRONTEND_HOST", "0.0.0.0"),
        PORT: envValue("FRONTEND_PORT", "3000"),
        ...
        GUEST_SUBMISSION_RATE_LIMIT_SECRET: envValue("GUEST_SUBMISSION_RATE_LIMIT_SECRET"),
        RSVP_RATE_LIMIT_SECRET: envValue("RSVP_RATE_LIMIT_SECRET"),
        NEXT_PUBLIC_SITE_URL: envValue("NEXT_PUBLIC_SITE_URL"),
        NGATURI_TRUSTED_PROXY_HOPS: envValue("NGATURI_TRUSTED_PROXY_HOPS"),
